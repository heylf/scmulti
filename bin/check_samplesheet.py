...
class RowChecker:
    ...
    def validate_unique_samples(self):
        ...
        number of times the same sample exist, but with different h5 files, e.g., multiple runs per experiment.

        """
        if len(self._seen) != len(self.modified):
            raise AssertionError("The pair of sample name and h5 must be unique.")
        seen = Counter()
